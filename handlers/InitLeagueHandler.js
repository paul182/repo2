...
module.exports = (options, server, request, reply) => {
    ...
    const matchUpdateQuery = `update matches set team1game1 = 0, team1game2 = 0, team1game3 = null,
        team2game1 = 0, team2game2 = 0, team2game3 = null, winner = null, gameTS = null where round = 1 and group in ('C', 'D', 'E', 'F')`;
    ...
    const leagueUpdateQuery = `update league l set 
        ...
        where round = 1 and group in ('C', 'D', 'E', 'F')`;
